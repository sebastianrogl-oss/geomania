// BACKUP - Karten-Quiz - Stand: 2026-06-17
// Originalpfad: lib/screens/map_quiz_screen.dart
//
// Benötigte Pakete (pubspec.yaml):
//   flutter_map: ^8.3.0
//   latlong2: ^0.9.1
//   shared_preferences: ^2.3.3
//
// Asset (pubspec.yaml unter flutter > assets):
//   assets/geo/ne_50m_countries.geojson
//
// Wiederherstellen:
//   1. Diese Datei nach lib/screens/map_quiz_screen.dart kopieren
//   2. Pakete in pubspec.yaml eintragen (falls nicht vorhanden)
//   3. GeoJSON aus backups/karten_quiz/assets/geo/ nach assets/geo/ kopieren
//   4. Import in home_screen.dart einkommentieren (Zeile mit "map_quiz_screen.dart")
//   5. Import in lernen_screen.dart einkommentieren
//   6. MapQuizScreen-Referenzen in home_screen.dart einkommentieren (case 'map' + _ChallengeInfo)
//   7. KategorieCard 'Karte meistern' in lernen_screen.dart einkommentieren
//   8. rawMapQ-Variablen in lernen_screen.dart einkommentieren
