// Übersetzungen für main.dart (Bottom-Nav) + settings_screen.dart.
const Map<String, String> uebersetzungenSettings = {
  'Home': 'Home',
  'Rangliste': 'Leaderboard',
  'Profil': 'Profile',

  'Spieler': 'Player',
  'Anzeigename ändern': 'Change display name',
  'Dein Name': 'Your name',
  'Muss zwischen 2 und 16 Zeichen lang sein':
      'Must be between 2 and 16 characters long',
  'Speichern': 'Save',

  'PROFIL': 'PROFILE',
  'SPRACHE': 'LANGUAGE',
  'TON & HAPTIK': 'SOUND & HAPTICS',
